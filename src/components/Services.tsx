...
const services = [
  {
    title: "Web / Frontend",
    description:
      "Pixel-perfect interfaces built with React, Next.js, and modern frameworks. Responsive, performant, and accessible.",
  ...
  },
  {
    title: "Backend / APIs",
    description:
      "Scalable server-side architecture, RESTful & GraphQL APIs, microservices, and real-time systems that handle millions of requests.",
  ...
  },
  {
    title: "Cloud & DevOps",
    description:
      "Infrastructure as code, CI/CD pipelines, and cloud-native deployments on AWS, Azure, and GCP.",
  ...
  },
  {
    title: "Mobile Apps",
    description:
      "Native and cross-platform mobile experiences for iOS and Android with smooth animations and offline-first architecture.",
  ...
  },
  {
    title: "QA & Testing",
    description:
      "Automated test suites, regression testing, security audits, and CI-integrated quality assurance pipelines.",
  ...
  },
  {
    title: "Integrations",
    description:
      "Seamless third-party integrations, data pipelines, webhooks, and message queues connecting your entire tech stack.",
    ...
    <section id="services" className="relative py-28 md:py-36 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        >
          ...
          <p className="mt-4 text-white/30 max-w-lg text-base leading-relaxed">
            Six core competencies, one unified team. We cover the full stack so
            you don&apos;t have to juggle vendors.
          </p>
        </motion.div>
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {service.skills.map((skill) => (
                      <span
                        key={skill}
                        className="px-2.5 py-1 rounded-md text-[10px] font-medium bg-white/4 text-white/25 group-hover:text-white/50 group-hover:bg-white/6 border border-white/4 transition-all duration-300"
                      >
                        {skill}
                      </span>
                    ))}
